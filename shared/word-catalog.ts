...
export const WORD_CATALOG = {
  ...
  10: WORD_CATALOG_DATA.words.filter((entry) => entry.word.length <= 10 && (entry.boards.includes(4) || entry.boards.includes(6) || entry.boards.includes(8))),
} as const;
...
const THEME_WORDS: Record<Exclude<WordTheme, "general">, readonly string[]> = {
  nature: ["ADA", "ARI", "BAL", "DAL", "GÖL", "GÜL", "KUM", "TAŞ", "YAZ", "ELMA", "DENİZ", "ÇİÇEK", "BAHÇE", "ORMAN", "SAHİL", "YAPRAK", "YILDIZ", "YAĞMUR", "BULUT", "GÜNEŞ", "TOPRAK", "MEVSİM", "NEHİR", "GÖKKUŞAĞI", "RÜZGAR", "KIYILAR", "KUTUPLAR"],
