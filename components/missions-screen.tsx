...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 22, lineHeight: 26, marginTop: 1 },
  totalBadge: {
  ...
  summaryTitle: { color: palette.cream, fontSize: 14, fontWeight: "900", marginTop: 2 },
  ...
  sectionTitle: { color: palette.goldBright, fontSize: 11, fontWeight: "900", letterSpacing: 1.1 },
  ...
  missionTitle: { flex: 1, color: palette.cream, fontSize: 14, fontWeight: "900", letterSpacing: 0.2 },
